...
export const userTypeCreation = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const userTypeUpdate = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const AllUserType = async (req: Request, res: Response, next: NextFunction) => {
  try {
...
export const getUType = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const id = parseInt(req.params.id)
    // eslint-disable-next-line @typescript-eslint/no-unused-expressions

    const usertype = await getUserType(id)
    return res.status(200).json(usertype.rows)
  } catch (error) {
    next(error)
  }
}
// DELETE SPECIFIC USERTYPE
export const deleteUType = async (req: Request, res: Response, next: NextFunction) => {
  try {
    const id = parseInt(req.params.id)
